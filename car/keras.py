...
from car.types import TubRecord
from car.utils import normalize_image, linear_bin
from car.interpreter import Interpreter, KerasInterpreter
...
class KerasCategorical(KerasPilot):
    ...
    distribution over all choices. This uses the car.utils.linear_bin and
    car.utils.linear_unbin to transform continuous real numbers into a range
    ...
    def interpreter_to_output(self, interpreter_out):
        ...
        throttle = utils.linear_unbin(throttle_binned, N=N,
...
class KerasInferred(KerasPilot):
    ...
    def interpreter_to_output(self, interpreter_out):
        steering = interpreter_out[0]
        return steering, utils.throttle(steering)
