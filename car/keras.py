...
class KerasCategorical(KerasPilot):
    ...
    distribution over all choices. This uses the utils.linear_bin and
    utils.linear_unbin to transform continuous real numbers into a range
...
class KerasBehavioral(KerasPilot):
    ...
    def inference(self, img_arr, state_array):
        ...
        if N > 0:
            throttle = utils.linear_unbin(throttle, bins=N, offset=0.0, range_r=0.5)
        else:
