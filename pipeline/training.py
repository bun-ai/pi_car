...
from car.utils import get_model_by_type, normalize_image, train_test_split
from car.interpreter import keras_model_to_tflite, saved_model_to_tensor_rt
from pipeline.database import PilotDatabase
...
def train(cfg: Config, tub_paths: str, model: str = None,
    ...
    training_records, validation_records = train_test_split(dataset.get_records(), shuffle=True,
